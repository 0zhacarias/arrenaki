...
Route::post('/confirma-arrendar', [App\Http\Controllers\ActividadeImoveisController::class, 'confirma_arrendar'])->name('cancelar');
Route::post('/cancelado-arrendar', [App\Http\Controllers\ActividadeImoveisController::class, 'cancelado_arrendar'])->name('cancelar');
