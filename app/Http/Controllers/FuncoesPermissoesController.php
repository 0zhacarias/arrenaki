...
class FuncoesPermissoesController extends Controller
{
    ...
    {
        $data['roles'] = Role::where('deleted_at',null)->with('permissions')->get();
        $data['permissions'] = Permission::where('deleted_at',null)->with('roles')->get();
    ...
    public function getRoles(Request $request)
    {
        ...
        if ($role_id) {
            $roles = Role::where('deleted_at',null)->with('permissions')->where('id', $role_id)->first();
        }
