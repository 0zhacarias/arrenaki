...
class ClienteController extends Controller
{
    ...
    public function atualizar_perfil(Request $request)
    {
        ...
        if ($request->usuario['tipo_user_id'] == 1) {
            ...
            // $utilizador->revokePermissionTo('');
            $utilizador->assignRole('Locatario');
    ...
    {
        $dados['roles'] = Role::where('deleted_at',null)->with('permissions')->get();
        $dados['permissions'] = Permission::where('deleted_at',null)->with('roles')->get();
        // dd($dados);
    ...
    public function perfil_cliente()
    {
        ...
        if (auth()->user()) {
            ...
            $dados['vazio'] = '';
            $dados['meus_imoveis'] = Imoveis::with('tipologiaImoveis','municipio.provincia','solicitacaoImoveis','fotosImoveis', 'condicaoImoveis', 'actividadeImoveis.operacaoImoveis', 'estadoImoveis')->orderBy('created_at', 'desc')->get();
            $dados['meus_pagamentos'] = Imoveis::with('tipologiaImoveis','municipio.provincia','solicitacaoImoveis','fotosImoveis', 'condicaoImoveis', 'actividadeImoveis.operacaoImoveis', 'estadoImoveis')->get();
    ...
    public function perfil()
    {
        ...
        if (auth()->user()) {
            ...
            if ($userLog->tipo_user_id == 1) {
                ...
                $dados['imoveis_processos'] = Imoveis::whereIn('id', $id_user_marca_visita)->whereIn('estado_imoveis_id', [4, 5, 6, 7, 8])
                    ->with('tipologiaImoveis','municipio.provincia','tipologiaImoveis','municipio.provincia','solicitacaoImoveis','fotosImoveis', 'condicaoImoveis', 'actividadeImoveis.operacaoImoveis', 'estadoImoveis')->get();
            }
    ...
    public function anuncios()
    {
        ...
        if (auth()->user()) {
            ...
            if ($userLog->tipo_user_id == 1) {
                ...
                $dados['imoveis_processos'] = Imoveis::
                    with('tipologiaImoveis','municipio.provincia','solicitacaoImoveis','fotosImoveis', 'condicaoImoveis', 'actividadeImoveis.operacaoImoveis', 'estadoImoveis')
                    ->get();
            } else {
                $dados['operacoes'] = OperacaoImoveis::whereIn('id',[2,3])->get();
                $dados['meus_imoveis'] = Imoveis::where('publicado_por', $userLog->id)
                ->with('tipologiaImoveis','municipio.provincia','solicitacaoImoveis','fotosImoveis', 'condicaoImoveis', 'actividadeImoveis', 'estadoImoveis')->orderBy('created_at', 'desc')->get();
                $dados['imoveis_processos'] = Imoveis::whereIn('id', $id_user_marca_visita)
            ...
            $dados['vazio'] = '';
            $dados['meus_imoveis'] = Imoveis::with('tipologiaImoveis','municipio.provincia','fotosImoveis', 'condicaoImoveis', 'actividadeImoveis.operacaoImoveis', 'estadoImoveis')->orderBy('created_at', 'desc')->get();
            $dados['meus_pagamentos'] = Imoveis::with('tipologiaImoveis','municipio.provincia','fotosImoveis', 'condicaoImoveis', 'actividadeImoveis.operacaoImoveis', 'estadoImoveis')->get();
